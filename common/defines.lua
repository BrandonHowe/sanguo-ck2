...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_STEWARDSHIP_MULT = 0.05,	-- Extra Max Demesne Size from ruler and spouse stewardship
	...
	VASSAL_LIMIT_DUKE_MULT = 3.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_KING_MULT = 5.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_EMPEROR_MULT = 10.0, 			-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_GREAT_DUKE_BONUS = 3.0, 		-- Extra Vassal Limit for Dukes with more than one Duchy
	VASSAL_LIMIT_DIPLOMACY_MULT = 0.1,			-- Extra Vassal Limit from ruler and spouse diplomacy
	...
	CONCLAVE_VASSAL_LIMIT_KING_MULT = 5.0, 				-- Extra Vassal Limit from the ruler's rank
	...
	MAX_DIPLO_DISTANCE = 300,									-- Most diplomacy is disallowed if two rulers are too distant
...
NCouncil = {
	...
	ENFORCE_PEACE_LENGTH = 24,									-- How many months Enforce Peace is active for
	ENFORCE_PEACE_START_DELAY = 3,								-- How many months it takes before the enforce peace becomes active
	ENFORCE_PEACE_BLOCK_LENGTH = 12,							-- How many months Enforce peace is blocked when vassal uses the interaction.
	ENFORCE_PEACE_COOLDOWN = 24,								-- How many months liege has to wait before he can use enforce peace again.
...
NCharacter = {
	...
	EARLY_PORTRAIT_AND_UNIT_BEFORE_YEAR = 220,		-- Before this date, early versions of Units and Portraits will be used if available
	LATE_PORTRAIT_AND_UNIT_AFTER_YEAR = 300,		-- After this date, late versions of Units and Portraits will be used if available
	...
	AGE_CHILDHOOD_PULSE = 5,						-- The childhood pulse events start from this age
...
NNomad = {
	...
	MAX_POPULATION_EMPTY_HOLDING_MULTIPLIER = 15000,  -- Max population increase for each empty holding in provinces where the capital is also an empty holding
	...
	START_POPULATION = 0.80,						-- Starting population, multiplied with max population
	START_MANPOWER = 0.80,							-- Starting manpower, multiplied with max manpower
...
NMilitary = {
	...
	MERCENARY_HIRE_DISTANCE_THRESHOLD = 300,		-- Mercs will not be available if the province of origin is more distant from your capital
...
NTechnology = {
	DONT_EXECUTE_TECH_BEFORE = 184,				-- Set this to your earliest starting year
	...
	IDEAL_YEAR_LEVEL_0 = 184, 					-- the chance to get a progress to this level will increase after this date and decrease before it
	IDEAL_YEAR_LEVEL_8 = 800,
...
NEngine = {
	...
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_YEAR = 220, -- The missing scripted successor error will not be shown before this date
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_MONTH = 12,
	MISSING_SCRIPTED_SUCCESSOR_ERROR_CUTOFF_DAY = 10,
...
NAI =
{
	...
	CRUSADE_CREATION_MONTH_DELAY = 60,						-- Months from the end of one Crusade before the AI will call a new one
